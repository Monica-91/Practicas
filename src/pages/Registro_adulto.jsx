 ...
 //formulario
  ...
  const [terminos, cambiarTerminos] = useState(false);
	...
	const onSubmit = (e) => {
      ...
      const usue = { nom_n, apell_n, doc_n, fec_nac, gen_n, sang, nac_n, nom, apell, doc, gen, part, dir, corr, cel, nac, cla};
      ...
      <div className="navbar navbar-inverse ">
        <div className="container">
          ...
          <div className="navbar-collapse collapse">
            ...
            <li className="active"><Link to='/'> CANCELAR  <br/> REGISTRO </Link></li>
          ...
          <div className="row centered">
            <p><h1><b>Datos del Niño</b></h1></p>
              ...
              <Formulario action="" onSubmit={onSubmit}>
                ...
                <br/><br/>
                <div className="row centered">
                  <p><h1><b>Datos del Adulto</b></h1></p>
                </div>
