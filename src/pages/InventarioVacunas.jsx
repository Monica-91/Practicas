...
export const InventarioVacunas = () => {
  return (
    <Fragment>
      ...
      <div className="navbar navbar-inverse ">
        <div className="container">
          ...
          <div className="navbar-collapse collapse">
            ...
            <li className="active"><Link to='/vacunas'> VACUNAS </Link></li>
            <li className="active"><Link to='/usuario-externo'> USUARIO EXTERNO </Link></li>
        ...
        <div className="container">
          <div className="row centered">
            <div className="col-lg-7">
              <label for="">Ingresar Esquema de Vacunación</label>
              <br/><br/><br/>
